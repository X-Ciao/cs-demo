...
//    // 使用 OnNetworkSpawn 替代 Start 进行网络对象初始化
//    public override void OnNetworkSpawn()
//    {
//        if (!IsOwner)
//        {
...
//        // 使用 Move 而不是 SimpleMove 避免自动重力
//        CharacterControllerPlayer.Move(move * Speed * Time.deltaTime);

//        // 应用重力
//        velocity.y += gravity * Time.deltaTime;
//        CharacterControllerPlayer.Move(velocity * Time.deltaTime);
//    }
...
//    {
//        bool isMoving = (Input.GetAxis("Horizontal") != 0 || Input.GetAxis("Vertical") != 0);
//        if (isMoving && CharacterControllerPlayer.isGrounded)
//        {
//            if (!footPlayer.isPlaying) footPlayer.Play();
//        }
//        else if (footPlayer.isPlaying)
//        {
//            footPlayer.Stop();
//        }
//    }
